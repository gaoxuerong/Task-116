...
请输入你的选择（1～3）：`);
    ...
    it('first write 1 and write the right information',()=>{
        ...
        readlineSync.question.onSecondCall().returns("章歆,1505110027,汉,201502,数学:100,语文:90,英语:80,编程:70");
        readlineSync.question.onThirdCall().returns(Choice.exit);
        main();
        expect(console.log.args.join()).toBe("学生章歆的成绩被添加,已退出");
    });
    ...
    it('should ask to retry when add student info failed', () => {
        ...
        readlineSync.question
            ...
            .onCall(2).returns("章歆,1505110027,汉,201502,数学:100,语文:90,英语:80,编程:70")
